		...
		<div class="main-content-inner">
			<div id="breadcrumbs" class="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li>
						<a href="#"><?php echo L('category_manage');?></a>
					</li>
					<li class="active"><?php echo L('category_list');?></li>
				</ul>
					...
					<div class="col-xs-12">
						<div class="row">
							<div class="col-xs-12">
								<div class="row">
									<div class="col-xs-12">
									<a href='<?php echo U('category/add');?>'><button id='add_article' class="btn btn-primary btn-sm col-xl-2" type="button">
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-1">
									<thead>
										<tr>
											...
											<th class="center" width="30%"><?php echo L('cate_name');?></th>
											<th class="center" width="15%"><?php echo L('cate_order_sort');?></th>
											<th class="center hidden-480"><?php echo L('is_nav');?></th>

											<th class="center">
												<i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
												<?php echo L('cate_add_time');?>
											</th>
											<th class=" center hidden-480"><?php echo L('cate_status');?></th>

											<th class="center"><?php echo L('cate_opt');?></th>
										</tr>
									</thead>
									<?php if(is_array($cate_list)): foreach($cate_list as $key=>$vo): ?><tr class="">
											<td class="center">
												<label class="position-relative">
													<input type="checkbox" class="ace">
													<span class="lbl"></span>
											...
											<td>
												<?php echo str_repeat('--',$vo[level]*2);?>&nbsp;&nbsp;<a href="#"><?php echo ($vo["cate_name"]); ?></a>
											</td>
											<td><?php echo ($vo["order_sort"]); ?></td>
											<td class="hidden-480"><?php echo ($vo['is_nav'] ? '显示':'隐藏'); ?></td>
											<td><?php echo (date('Y-m-d',$vo["add_time"])); ?></td>

											<td class="hidden-480 center">
												<span class="label label-sm label-warning"><?php echo ($vo['status'] ? '启用':'未启用'); ?></span>
											</td>

											<td class="center">
												<div class="hidden-sm hidden-xs btn-group">
													<a href='<?php echo U('category/edit',array('id'=>$vo['id']));?>'><button class="btn btn-xs btn-info">
														<i class="ace-icon fa fa-pencil bigger-120"></i>
													</button></a>
	
													<a href='javascript:' onclick="del(this,<?php echo ($vo['id']); ?>)">
