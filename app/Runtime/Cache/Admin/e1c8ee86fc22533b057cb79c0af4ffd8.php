		...
		<div class="main-content-inner">
			<div id="breadcrumbs" class="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li class="active"><?php echo L('article_add');?></li>
				</ul>
			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						<div class="row">
							<div class="col-xs-12">
								<div class="row">
									<div class="col-xs-12">
									<a href='<?php echo U('article/list');?>'><button class="btn btn-white btn-primary btn-sm-2 col-xl-2" type="button">
					...
					<div class="col-xs-12">
						<div class="row">
							<div class="col-xs-6 col-sm-10">
								...
								<div class="tabbable">
									...
									<form role="form" method="post" class="form-horizontal" action="/index.php?m=admin&c=article&a=add">
										...
										<div id="base" class="tab-pane fade active in">
												...
												<div class="form-group">
													<label class="col-sm-2 control-label no-padding-left" for="article_title">文章标题</label>
														<input type="text" value="" name="article_title" id="article_title" placeholder="article_title" class="col-xs-10 col-sm-5">
												</div>
												<div class="form-group">
													<label class="col-sm-2 control-label no-padding-left" for="author">文章作者</label>
														<input type="text" value="" name="author" id="author" placeholder="author" class="col-xs-10 col-sm-5">
												</div>
												<div class="form-group">
													<label class="col-sm-2 control-label no-padding-left" for="sort_id">文章分类</label>
														<select class="select" name="sort_id">
															<option>请选择</option>
															<?php if(is_array($list)): foreach($list as $key=>$vo): ?><option value='<?php echo ($vo["id"]); ?>'><?php echo ($vo["cate_name"]); ?></option><?php endforeach; endif; ?>
														</select>
												</div>
												<div class="form-group">
  					...
  					<input type="text" id="thumb_img" name="thumb_img" placeholder="thumb_img" value="">
  					<input type="button" class="btn btn-default btn-sm" id="thumb_imgs" value="选择图片" />
  					<a href="" id="imgs_url2" target="_blank"><img src="/Public/data/admin/images/demo.gif" id="imgs_url" style="width:30px;height:30px;"/></a>
												...
												<div class="form-group">
													...
													<input type="text" id="add_time" name="add_time" value="" data-date-format="yyyy-mm-d"/>
												...
												<div class="form-group">
													...
													<div class="col-xl-9">
														<textarea id="content" name="content" placeholder="content" style="width:600px;height:260px;resize:none" class="col-xs-10 col-sm-6"></textarea>
													</div>
												</div>
										...
										<div id="seo" class="tab-pane fade">
											<div class="form-group">
													<label class="col-sm-2 control-label no-padding-left" for="article_title">文章关键字</label>
														<input type="text" value="" name="keywords" id="keywords" placeholder="keywords" class="col-xs-10 col-sm-5">
											</div>
											<div class="form-group">
													<label class="col-sm-2 control-label no-padding-left" for="description">文章描述</label>
														<input type="text" value="" name="description" id="description" placeholder="description" class="col-xs-10 col-sm-5">
											</div>
											<div class="form-group">
													<label class="col-sm-2 control-label no-padding-left" for="click">点击量</label>
														<input type="text" value="" name="click" id="description" placeholder="click" class="col-xs-10 col-sm-5">
											</div>
											<div class="form-group">
													<label class="col-sm-2 control-label no-padding-left" for="a_hot">是否推荐</label>
														<div class="radio">
													<label>
														<input type="radio" value='1' name="a_hot" checked="checked" class="ace" name="form-field-radio">
														<span class="lbl"> 推荐</span>
													</label>
											
													<label>
														<input type="radio" value='0' name="a_hot" class="ace" name="form-field-radio">
											...
											<div class="form-group">
													...
													<div class="col-xl-9">
													<textarea id="small_content" name="small_content" placeholder="small_content" style="width:600px;height:260px;resize:none" class="col-xs-10 col-sm-6"></textarea>
