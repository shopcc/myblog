...
<body class="no-skin">
					...
					<div class="col-xs-12">
						<div class="row">
							<div class="col-xs-12">
								<div class="row">
									<div class="col-xs-12">
									<a href='<?php echo U('article/add');?>'><button id='add_article' class="btn btn-white btn-primary btn-sm-2 col-xl-2" type="button">
    ...
    $('#paginations').twbsPagination({
        ...
        onPageClick: function (event, page) {
            if(page <=0) page =1;
            $.post('<?php echo U('article/list');?>',{page:page},function(data){
    ...
    $(document).on('click',$("input[name='aid[]']"),function(){
  	...
  	$('.nav-search-input').bind('keypress',function(event){
  		if(event.keyCode =='13'){
  			$.post('<?php echo U('article/search');?>',{keyword:$('.nav-search-input').val()},function(data){
  				$('#article_list').html(data);
  			});
  		}
  	});
