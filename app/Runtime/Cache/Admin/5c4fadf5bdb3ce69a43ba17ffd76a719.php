					...
					<div class="col-xs-12">
						<div class="row">
							<div class="col-xs-6 col-sm-10">
								...
								<form method="post" action="<?php echo U('category/add');?>" class="form-horizontal" role="form">
								...
								<div class="form-group">
													<label class="col-sm-2 control-label no-padding-left" for="article_title"><?php echo L('cate_name');?></label>
														<input type="text" value="" name="cate_name" id="cate_name" placeholder="cate_name" class="col-xs-10 col-sm-5">
								</div>
								<div class="form-group">
													<label class="col-sm-2 control-label no-padding-left" for="article_title"><?php echo L('cate_order_sort');?></label>
														<input type="text" value="" name="order_sort" id="order_sort" placeholder="order_sort" class="col-xs-10 col-sm-5">
								</div>
								<div class="form-group">
													<label class="col-sm-2 control-label no-padding-left" for="article_title"><?php echo L('is_nav');?></label>
															
													<label>
														<input name="is_nav" class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" value="1">
														<span class="lbl"></span>
													</label>
								</div>
								<div class="form-group">
													...
													<label>
														<input name="status" class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" value="1">
														<span class="lbl"></span>
													</label>
								</div>
