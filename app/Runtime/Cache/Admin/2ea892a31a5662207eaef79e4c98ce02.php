		...
		<div class="main-content-inner">
			<div id="breadcrumbs" class="breadcrumbs">
				...
				<ul class="breadcrumb">
					...
					<li class="active highlight"><?php echo L('category_add');?></li>
				</ul>
			</div>
					...
					<div class="col-xs-12">
						<div class="row">
							<div class="col-xs-6 col-sm-10">
								...
								<form method="post" action="<?php echo U('category/edit',array('id'=>$cate['id']));?>" class="form-horizontal" role="form">
								<div class="form-group">
													<label class="col-sm-2 control-label no-padding-left" for="pid"><?php echo L('cate_name');?></label>
													<select name='pid'>
														<option value='0'>顶级分类</option>
														<?php if(is_array($list)): foreach($list as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if(vo.id == $cate['pid']): ?>selected<?php endif; ?>><?php echo ($vo["cate_name"]); ?></option><?php endforeach; endif; ?>
													</select>
								</div>
								<div class="form-group">
													<label class="col-sm-2 control-label no-padding-left" for="article_title"><?php echo L('cate_name');?></label>
														<input type="text" value="<?php echo ($cate["cate_name"]); ?>" name="cate_name" id="cate_name" placeholder="cate_name" class="col-xs-10 col-sm-5">
								</div>
								<div class="form-group">
													<label class="col-sm-2 control-label no-padding-left" for="article_title"><?php echo L('cate_order_sort');?></label>
														<input type="text" value="<?php echo ($cate["order_sort"]); ?>" name="order_sort" id="order_sort" placeholder="order_sort" class="col-xs-10 col-sm-5">
								</div>
								<div class="form-group">
													<label class="col-sm-2 control-label no-padding-left" for="article_title"><?php echo L('is_nav');?></label>
															
													<label>
														<input name="is_nav" class="ace ace-switch ace-switch-4 btn-flat" <?php if($cate['is_nav'] == true): ?>checked<?php endif; ?> type="checkbox" value="1">
														<span class="lbl"></span>
													</label>
								</div>
								<div class="form-group">
													<label class="col-sm-2 control-label no-padding-left" for="status"><?php echo L('cate_status');?></label>
													<label>
														<input name="status" class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" value="1" <?php if($cate['status'] == true): ?>checked<?php endif; ?> >
														<span class="lbl"></span>
													</label>
								</div>
